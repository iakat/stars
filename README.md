...
- [flyitalyadsb/flyitalyadsb-site](https://github.com/flyitalyadsb/flyitalyadsb-site) - Sito pubblico flyitalyadsb.com — Astro + Tailwind, deploy su Cloudflare Pages

## Batchfile 

- [Manut0/emuscan](https://github.com/Manut0/emuscan) - 
...
- [zilluss/Open-Nuki-Fob](https://github.com/zilluss/Open-Nuki-Fob) - Open Source Nuki Fob based on the the NRF52832 SoC
- [polhenarejos/pico-fido](https://github.com/polhenarejos/pico-fido) - FIDO Passkey for Raspberry Pico and ESP32
- [liboabo/nginx-ja4-ebpf-module](https://github.com/liboabo/nginx-ja4-ebpf-module) - Fingerprints ja4+ with ebpf technology
...
- [makerdiary/nrf9151-connectkit](https://github.com/makerdiary/nrf9151-connectkit) - Versatile Prototyping Kit based on the nRF9151 SiP supporting LTE-M/NB-IoT/NTN, DECT NR+ and GNSS
- [SolderSniffer/SleepyTime](https://github.com/SolderSniffer/SleepyTime) - Ultra Low Power Epaper Watch Firmware
...
- [I-AM-ENGINEER/RNode_Halow_Firmware](https://github.com/I-AM-ENGINEER/RNode_Halow_Firmware) - RNode implementation based on the Taixin TXW8301, using the 802.11ah (Wi-Fi HaLow) LMAC layer as a raw radio transport for building mesh networks.  The goal of this project is to repurpose low-cost Ch
- [idan2025/Rnode_Firmware](https://github.com/idan2025/Rnode_Firmware) - RNode firmware for the Seeed Studio SenseCAP T1000-E (nRF52840 + Semtech LR1110)
- [flipperencore/flipperzero-encore](https://github.com/flipperencore/flipperzero-encore) - Encore Firmware for Flipper Zero
- [kiisu-io/kiisu-firmware](https://github.com/kiisu-io/kiisu-firmware) - Kiisu firmware source code — fork of Flipper Zero OFW adapted for KIISU V4
...
- [kiisu-io/kiisu4-companion-fw](https://github.com/kiisu-io/kiisu4-companion-fw) - Aux MCU (STM32G4) firmware for Flipper Zero compatibility on KIISU V4
- [sethtroisi/gmp-ecm](https://github.com/sethtroisi/gmp-ecm) - Imported from svn://scm.gforge.inria.fr/svnroot/ecm/
- [AllogeneSSRD/opencl-ecm](https://github.com/AllogeneSSRD/opencl-ecm) - GMP-ECM with OpenCL — Heterogenous computing across Windows, Linux & Android. Supports GPU (AMD, NVIDIA, Intel, Qualcomm Adreno, Huawei Mali) and accelerators (NPU: Xilinx FPGA, AMD AIE).
- [bazuchan/keychain-pkcs11](https://github.com/bazuchan/keychain-pkcs11) - A shared library that implements a PKCS#11 interface to the Apple Security framework
- [shokerplz/ft9362-driver](https://github.com/shokerplz/ft9362-driver) - 
...
- [pulpoff/asterisk-chan-dongle](https://github.com/pulpoff/asterisk-chan-dongle) - Asterisk GSM dongle support
- [grtel/asterisk-chan-quectel](https://github.com/grtel/asterisk-chan-quectel) - Asterisk channel driver for Quectel and Simcom modules
- [smx-smx/asterisk-chan-dongle](https://github.com/smx-smx/asterisk-chan-dongle) - chan_dongle channel driver for Huawei UMTS cards, works with Asterisk 14+
- [perillamint/asterisk-chan-quectel](https://github.com/perillamint/asterisk-chan-quectel) - Asterisk channel driver for Quectel and Simcom modules, works with Asterisk-13+
- [harinworks-org/asterisk-chan-quectel](https://github.com/harinworks-org/asterisk-chan-quectel) - Asterisk channel driver for Quectel and SimCOM modules
- [elkir0/asterisk-chan-quectel](https://github.com/elkir0/asterisk-chan-quectel) - Asterisk channel driver for Quectel and SimCOM modules
- [biaide/asterisk-chan-quectel](https://github.com/biaide/asterisk-chan-quectel) - Asterisk channel driver for Quectel modules
- [sahib/rmlint](https://github.com/sahib/rmlint) - Extremely fast tool to remove duplicates and other lint from your filesystem
- [mrbreaker/why2025-linux](https://github.com/mrbreaker/why2025-linux) - Getting native NOMMU Linux running on the WHY2025 badge.
...
- [sq5bpf/telive-2](https://github.com/sq5bpf/telive-2) - Tetra live monitor - experimental version
- [sq5bpf/osmo-tetra-sq5bpf-2](https://github.com/sq5bpf/osmo-tetra-sq5bpf-2) - Fork of BorjanEch0/osmo-tetra , which is a fork of the original Osmocom TETRA MAC/PHY experimentation code; Mirrored from https://gitea.osmocom.org/tetra/osmo-tetra
- [sq5bpf/teatime](https://github.com/sq5bpf/teatime) - TEAtime - TEA1 short key recovery
- [RfidResearchGroup/proxmark3](https://github.com/RfidResearchGroup/proxmark3) - Iceman Fork - Proxmark3
- [cjbrigato/kigiv-for-proxmark3](https://github.com/cjbrigato/kigiv-for-proxmark3) - KIGIV stands for Reverse VIGIK, the French Residential and Postal/State services Residential Security system. (www.vigik.com)
- [wakdev/nfctools-fz](https://github.com/wakdev/nfctools-fz) - NFC Tools for Flipper Zero
...
- [antirez/PixelWall](https://github.com/antirez/PixelWall) - Collection of programs that generate animations to project onto a pixel wall.
...
- [pmvr/pykey](https://github.com/pmvr/pykey) - Python based implementaton of FIDO2 and U2F on a NRF52840 Dongle (PCA10059)
- [makerdiary/nrf52-u2f](https://github.com/makerdiary/nrf52-u2f) - An Open-Source FIDO U2F implementation on nRF52 SoC
- [proxytunnel/proxytunnel](https://github.com/proxytunnel/proxytunnel) - Stealth tunneling through HTTP(S) proxies
- [Protocentral/healthypi-move-fw](https://github.com/Protocentral/healthypi-move-fw) - Firmware codebase based on Zephyr for the HealthyPi Move system
...
- [stefantalpalaru/w_scan2](https://github.com/stefantalpalaru/w_scan2) - w_scan fork (channel scan tool which generates ATSC, DVB-C, DVB-S/S2 and DVB-T/T2 channels.conf files)
...
- [f00b4r0/acarsdec](https://github.com/f00b4r0/acarsdec) - ACARS SDR decoder
- [JPShag/PCILeech-DMA-Firmware](https://github.com/JPShag/PCILeech-DMA-Firmware) - The last Pcileech DMA CFW guide you will ever need. Sponsored by DMAPolice.com
...
- [TLeconte/vdlm2dec](https://github.com/TLeconte/vdlm2dec) - vdl mode 2 SDR decoder
- [nmatsuda/viz1090](https://github.com/nmatsuda/viz1090) - A visualizer for dump1090 ADSB data
- [latchset/tang](https://github.com/latchset/tang) - Tang binding daemon
- [QUB-ARM-STM32/Baby-Kyber](https://github.com/QUB-ARM-STM32/Baby-Kyber) - A simple implementation of baby kyber in C to run on an STM32
- [netpipe/Baby-Kyber](https://github.com/netpipe/Baby-Kyber) - A simple implementation of baby kyber
...
- [cgmb/euler](https://github.com/cgmb/euler) - An ASCII art fluid simulator
- [jtsylve/LiME](https://github.com/jtsylve/LiME) - LiME (formerly DMD) is a Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, such as those powered by Android. The tool supports acquiring
...
- [infinet/xt_wgobfs](https://github.com/infinet/xt_wgobfs) - Iptables WireGuard obfuscation extension. Windows/Mac/BSDs see the fully compatible cross-platform CLI rs-wgobfs.
...
- [eventphone/rfpproxy](https://github.com/eventphone/rfpproxy) - proxy to intercept communication between Mitel OMM and Mitel RFP
- [eventphone/mitel-api](https://github.com/eventphone/mitel-api) - .NET Library for the SIP-DECT OM Application XML Interface used by Mitel OMM.
- [prusa-dev/lpac-fibocom-wrapper](https://github.com/prusa-dev/lpac-fibocom-wrapper) - 
- [vgpastor/SDR-Tetra-Plugin](https://github.com/vgpastor/SDR-Tetra-Plugin) - Plugin to SDR# to interprete TETRA signals
- [snapetech/slskdN](https://github.com/snapetech/slskdN) - The feature-forward Soulseek web client. A richly enhanced fork of slskd; making Fidelity, Discovery, and Community all first-class features.
...
- [basiliscos/syncspirit](https://github.com/basiliscos/syncspirit) - continuous file synchronization program (BEP protocol implementation)
- [ratspeak/rsCardputer](https://github.com/ratspeak/rsCardputer) - Ratspeak for m5stack's Cardputer Adv - Reticulum/LXMF all in one.
...
- [RFnexus/modem73](https://github.com/RFnexus/modem73) - High speed software modem that works with any HF/VHF/UHF radio capable of 2400 Hz of bandwidth
- [sethtroisi/cado-nfs](https://github.com/sethtroisi/cado-nfs) - CADO-NFS is a complete implementation in C/C++ of the Number Field Sieve (NFS) algorithm for factoring integers. For official releases, please see the project website. http://cado-nfs.gforge.inria.fr
- [SarahRoseLives/DeDECTive](https://github.com/SarahRoseLives/DeDECTive) - The DECT Toolkit
- [AnthonySturdy/micro-radar](https://github.com/AnthonySturdy/micro-radar) - A tiny open-source flight radar for your desk
...
- [0xSeren/RTReticulum](https://github.com/0xSeren/RTReticulum) - A fast, power efficient, native Reticulum stack for embedded microcontrollers.
...
- [mgrone/stream1090](https://github.com/mgrone/stream1090) - Mode-S demodulation with CRC-based framing
- [piggz/harbour-amazfish](https://github.com/piggz/harbour-amazfish) - Amazfit Bip support for SailfishOS
- [odoare/RhyGa](https://github.com/odoare/RhyGa) - RhyGa, the Rhytmic Gate
- [IJHack/QtPass](https://github.com/IJHack/QtPass) - QtPass is a multi-platform GUI for pass, the standard unix password manager.
- [izabera/hdrhist](https://github.com/izabera/hdrhist) - a lightweight hdr histogram
- [jebinshaju/ESP32-Heart-Rate-Monitor](https://github.com/jebinshaju/ESP32-Heart-Rate-Monitor) - A demonstration project using an ESP32 and pulse sensor to measure heart rate and display it on the Blynk IoT platform. This setup allows real-time heart rate monitoring and visualization through a mo
...
- [CoolNamesAllTaken/adsbee](https://github.com/CoolNamesAllTaken/adsbee) - Open Source Embedded ADS-B Receiver
...
- [attermann/microReticulum_Firmware](https://github.com/attermann/microReticulum_Firmware) - Fork of RNode_Firmware with integration of the microReticulum network stack to implement a completeley self-contained standalone Reticulum node
...
- [cylonix/cylonix](https://github.com/cylonix/cylonix) - Fully open sourced client app alternative to Tailscale
...
- [a1e7de48f89e/hydrus-server-docker](https://github.com/a1e7de48f89e/hydrus-server-docker) - hydrus server running on Debian
...
- [eleboucher/forgesync](https://github.com/eleboucher/forgesync) - Pulls issues and comments from GitHub push-mirrors back into the source Forgejo repo. Stateless, marker-based.
- [kubeswift-io/kubeswift](https://github.com/kubeswift-io/kubeswift) - Kubernetes-native VM orchestration on Cloud Hypervisor
- [pinpox/punchcard](https://github.com/pinpox/punchcard) - Simple time tracking for small teams built with Go and HTMX with OIDC support
...
- [rsc/uncover](https://github.com/rsc/uncover) - Print uncovered code
- [gl0bal01/dorkhound](https://github.com/gl0bal01/dorkhound) - Fast Google dork URL generator for finding missing persons and TraceLab CTF competitions
...
- [iandees/survey-plane-finder](https://github.com/iandees/survey-plane-finder) - Watches ADSB streams to find planes performing surveys. Displays those planes on a map.
...
- [mevdschee/yealink-magician](https://github.com/mevdschee/yealink-magician) - Reset and reconfigure a Yealink T4X without admin credentials
...
- [willscott/sp3](https://github.com/willscott/sp3) - (SP)^3: A Simple, Practical, and Safe Packet Spoofing Protocol
...
- [noamsto/nix-amd-ai](https://github.com/noamsto/nix-amd-ai) - AMD AI inference stack for NixOS (XRT, XDNA plugin, FastFlowLM, Lemonade)
- [chainguard-forks/ingress-nginx](https://github.com/chainguard-forks/ingress-nginx) - Ingress NGINX Controller for Kubernetes
...
- [anatol/tang.go](https://github.com/anatol/tang.go) - Pure Golang implementation of server-side ECMR exchange functionality (Tang server)
- [angristan/krowl](https://github.com/angristan/krowl) - Distributed web crawler in Go
...
- [jgbrwn/vibebin](https://github.com/jgbrwn/vibebin) - vibebin: code and host inside Incus containers on your own VPS/server.
...
- [infradohq/headscale-operator](https://github.com/infradohq/headscale-operator) - Headscale Kubernetes Operator
...
- [mullvad/wgephemeralpeer](https://github.com/mullvad/wgephemeralpeer) - Mullvad Post-Quantum-secure WireGuard tunnels for vanilla WireGuard and custom integrations.
...
- [born-ml/born](https://github.com/born-ml/born) - Born is a modern ML framework for Go — train and deploy models as single binaries. Pure Go, zero CGO, GPU accelerated.
- [lwch/gotorch](https://github.com/lwch/gotorch) - golang libtorch binding
- [VigyatGoel/gotorch](https://github.com/VigyatGoel/gotorch) - GoTorch is a deep learning framework built from scratch in Go, designed to mimic the modular and flexible training loop style of PyTorch.
- [gluster/gluster-csi-driver](https://github.com/gluster/gluster-csi-driver) - DEPRECATED: Gluster Container Storage Interface (CSI) driver
...
- [coder/enterprise-helm](https://github.com/coder/enterprise-helm) - Operate Coder v1 on Kubernetes
...
- [sapslaj/valkey-leader](https://github.com/sapslaj/valkey-leader) - Kubernetes-native Valkey
- [dundee/gdu](https://github.com/dundee/gdu) - Fast disk usage analyzer with console interface written in Go
- [hdhauk/flickrdump](https://github.com/hdhauk/flickrdump) - Tool for downloading all images from a given Flickr account in parallel for max download speed. All images are downloaded in original size and albums are sorted into folders.
- [0xsha/CloudBrute](https://github.com/0xsha/CloudBrute) - Awesome cloud enumerator
- [lxc/cluster-api-provider-incus](https://github.com/lxc/cluster-api-provider-incus) - Cluster API implementation for Incus and LXD
...
- [trichner/gitc0ffee](https://github.com/trichner/gitc0ffee) - Git Commit Vanity Hash Solver
...
- [piyifan123/kubectl-yubikey-proxy](https://github.com/piyifan123/kubectl-yubikey-proxy) - A kubectl plugin starts a local proxy to use Yubikey PIV to authenticate with Kubernetes via mTLS.
...
- [vmware/k-bench](https://github.com/vmware/k-bench) - Workload Benchmark for Kubernetes
...
- [grgate/grgate](https://github.com/grgate/grgate) - Git release gate utility which autopublish draft/unpublished releases based on commit status
...
- [nrvnrvn/secreter](https://github.com/nrvnrvn/secreter) - ⛔️ DEPRECATED Kubernetes operator and CLI tool for encrypting and managing Kubernetes secrets
- [k3s-io/kine](https://github.com/k3s-io/kine) - Run Kubernetes on MySQL, Postgres, sqlite, not etcd.
- [k3d-io/k3d](https://github.com/k3d-io/k3d) - Little helper to run CNCF's k3s in Docker
- [CyrusNuevoDia/horoscope-api](https://github.com/CyrusNuevoDia/horoscope-api) - An API server for The Onion's horoscopes
...
- [andymeierdev/onepassword](https://github.com/andymeierdev/onepassword) - Thin wrapper around the 1Password CLI for use in Golang
...
- [presbrey/beyond](https://github.com/presbrey/beyond) - BeyondCorp-inspired HTTPS/SSO Access Proxy. Secure internal services outside your VPN/perimeter network during a zero-trust transition.
...
- [jitsi-contrib/jitsi-helm](https://github.com/jitsi-contrib/jitsi-helm) - A helm chart to deploy Jitsi to Kubernetes
...
- [ii/matey](https://github.com/ii/matey) - Combination of tmux+ttyd+wgtunnel to recreate experience of tmate
- [ZSWatch/Heartrate-DevKit-HW](https://github.com/ZSWatch/Heartrate-DevKit-HW) - The hardware repo for the ZSWatch heartrate sensor development kit.
...
- [Szybet/Yatchy](https://github.com/Szybet/Yatchy) - A modular, hackable, improved watchy like watch
- [RealityRipple/blobmoji](https://github.com/RealityRipple/blobmoji) - Blobmoji Temporary Fork
- [KindleModding/AdBreak](https://github.com/KindleModding/AdBreak) - experimental JB for ad-supported devices (5.18.1-5.18.5) (no Colorsoft & Scribe support)
- [ransome1/sleek](https://github.com/ransome1/sleek) - todo.txt manager for Linux, Windows and MacOS, free and open-source (FOSS)
- [DigitalDwagon/wpull](https://github.com/DigitalDwagon/wpull) - Wget-compatible web downloader and crawler.
- [cobraPA/rnode-flasher-iOS](https://github.com/cobraPA/rnode-flasher-iOS) - A web based firmware flasher for Reticulum / RNode_Firmware
...
- [aiwnios/Aiwnios](https://github.com/aiwnios/Aiwnios) - A HolyC Compiler/Runtime for aarch64/riscv64/amd64 windows/linux/macos/*bsd
- [aiwnios/EXODUS](https://github.com/aiwnios/EXODUS) - TempleOS in ring 3
...
- [jake-low/sourdough](https://github.com/jake-low/sourdough) - Sourdough is a free vector tile schema for OpenStreetMap data.
...
- [iipc/warc2html](https://github.com/iipc/warc2html) - Converts WARC files to static HTML
...
- [DarkPhilosophy/batt-watt-power-monitor](https://github.com/DarkPhilosophy/batt-watt-power-monitor) - Battery Time Remaining, Percentage, Watt Meter in Panel for GNOME Shell
- [pfeifferj/specdoc](https://github.com/pfeifferj/specdoc) - spec collaboration and lifecycling that isn't terrible
- [decolua/9router](https://github.com/decolua/9router) - Unlimited FREE AI coding. Connect Claude Code, Codex, Cursor, Cline, Copilot, Antigravity to FREE Claude/GPT/Gemini via 40+ providers. Auto-fallback, RTK -40% tokens, never hit limits.
- [Agent-FM/agentfm-core](https://github.com/Agent-FM/agentfm-core) - AgentFM is a peer-to-peer network that turns everyday computers into a decentralized AI supercomputer. AgentFM lets you run massive AI workloads directly across a global mesh of idle CPUs and GPUs.
- [bellingcat/iran-conflict-damage-proxy-map](https://github.com/bellingcat/iran-conflict-damage-proxy-map) - 
...
- [plectrm/plectrm](https://github.com/plectrm/plectrm) - Open-Source ASCII Tablature Editor
...
- [enaon/eucWatch](https://github.com/enaon/eucWatch) - EUC Watch. Dash for Electric Unicycles on NRF52xx based wearables. Supports Kingsong ( All models ), Inmotion ( All ), Ninebot ( All ) , Begode ( Gotway, All ) and Leaperkim (All)
...
- [Parcley27/AeroStream](https://github.com/Parcley27/AeroStream) - Real-time, free flight tracking for aircraft in your area and around the world. Powered by ADSB.lol and Leaflet interactive maps.
...
- [goodbyepavlyi/DiscordFS](https://github.com/goodbyepavlyi/DiscordFS) - DiscordFS: File storage with WebDav support and encryption
...
- [thedave42/f1tv-dl](https://github.com/thedave42/f1tv-dl) - Watch videos from f1tv locally
...
- [rtts/photog](https://github.com/rtts/photog) - Static photography website generator
...
- [a1e7de48f89e/hyve](https://github.com/a1e7de48f89e/hyve) - Expose and consume your hydrus media via HTTP API
...
- [warren-bank/node-HLS-Proxy](https://github.com/warren-bank/node-HLS-Proxy) - Node.js server to proxy HLS video streams
...
- [xPaw/MonsterMinigame](https://github.com/xPaw/MonsterMinigame) - ☠ Steam Summer Sale 2015 Monster Minigame fully reimplemented server clone
...
- [SteamGame/steamSummerMinigame](https://github.com/SteamGame/steamSummerMinigame) - :godmode: Steam Summer Sale 2015 - Auto-play Optimizer w/ Auto-Click
...
- [axivo/k3s-cluster](https://github.com/axivo/k3s-cluster) - High-availability K3s cluster deployed with Ansible.
...
- [dinozavyr/ADS-B-anomaly-detection](https://github.com/dinozavyr/ADS-B-anomaly-detection) - 
...
- [HypnosPy/HypnosPy](https://github.com/HypnosPy/HypnosPy) - A Device-Agnostic, Open-Source Python Software for Wearable Circadian Rhythm and Sleep Analysis and Visualization
...
- [fulvius31/wifi-wps-wpa-tester-opensource](https://github.com/fulvius31/wifi-wps-wpa-tester-opensource) - A limited and opensource version of the popular app WIFI WPS WPA TESTER
...
- [ArchiveTeam/microsoftupdate-grab](https://github.com/ArchiveTeam/microsoftupdate-grab) - Archiving Windows Update, drivers for now.
...
- [eznix86/anubis-kubernetes-operator](https://github.com/eznix86/anubis-kubernetes-operator) - Techaro's Anubis Firewall For Kubernetes
...
- [remcovanmook/draft-ipv6-resolved-gateway](https://github.com/remcovanmook/draft-ipv6-resolved-gateway) - This document requests the allocation of a new IPv4 special-purpose address from the IANA IPv4 Special-Purpose Address Registry. The proposed address, 192.0.0.11/32, is intended to serve as a signal t
- [oskar456/ietf-aaaa-filtering](https://github.com/oskar456/ietf-aaaa-filtering) - IETF Draft about filtering AAAA records in stub resolvers
...
- [applicative-systems/vzvm](https://github.com/applicative-systems/vzvm) - Faster linux-builder for macOS based on Virtualization.framework with Rosetta support
- [marcusramberg/nixos-fairphone-fp5](https://github.com/marcusramberg/nixos-fairphone-fp5) - NixOS port for Fairphone 5
- [cloud-gouv/bureautix-example](https://github.com/cloud-gouv/bureautix-example) - 
- [coder/box](https://github.com/coder/box) - The Box™ is a NixOS-based appliance for Coder
- [ii/nix](https://github.com/ii/nix) - ii shared NixOS modules — domain=user infrastructure
- [blitz/kvm-livepatch](https://github.com/blitz/kvm-livepatch) - NixOS Live Patch Experiments
...
- [ConnorBaker/nix-optimization](https://github.com/ConnorBaker/nix-optimization) - Nix flake for building Nix with PGO/CSPGO/BOLT
...
- [Freifunk-Luxembourg/nixos-config](https://github.com/Freifunk-Luxembourg/nixos-config) - 
...
- [poscat0x04/nixos-firewall-ng](https://github.com/poscat0x04/nixos-firewall-ng) - 
- [thequux/nix-zone-firewall](https://github.com/thequux/nix-zone-firewall) - Zone-based firewall for NixOS
...
- [davealtena/homelab](https://github.com/davealtena/homelab) - Running my own datacenter from the comfort of my own home
...
- [numtide/systemd-vaultd](https://github.com/numtide/systemd-vaultd) - Provide access to vault secrets to systemd services
...
- [LGUG2Z/nixos-hetzner-cloud-starter](https://github.com/LGUG2Z/nixos-hetzner-cloud-starter) - A sane, batteries-included starter template for running NixOS on Hetzner Cloud
- [soupglasses/alexandra](https://github.com/soupglasses/alexandra) - The Uncompromising Nix Code Formatter
...
- [speculor-app/speculor](https://github.com/speculor-app/speculor) - Speculor - real-time sensor and signal-processing engine. Public downloads + documentation.
- [catwell/postlima](https://github.com/catwell/postlima) - Tools and information for former users of Lima.
...
- [lorien/awesome-reticulum](https://github.com/lorien/awesome-reticulum) - A curated list of projects related to Reticulum Network
...
- [microsoft/Pride](https://github.com/microsoft/Pride) - Open source Pride design system
...
- [kilmu1337/pcileech-realtek-cardreader](https://github.com/kilmu1337/pcileech-realtek-cardreader) - 
...
- [SHUR1K-N/Flipper-Zero-Sub-GHz-Jamming-Files](https://github.com/SHUR1K-N/Flipper-Zero-Sub-GHz-Jamming-Files) - Looking for those jamming files that were removed from custom firmwares? Here they are. Only for educational purposes, of course.
- [shenghuo414/pcileech-AlcorMicroPCIECardReader](https://github.com/shenghuo414/pcileech-AlcorMicroPCIECardReader) - Original project from https://github.com/dom0ng/pcileech-cardreader?tab=readme-ov-file, I only on the perfect make its can be used directly, of course you can also perform other modifications
- [rothgar/awesome-tuis](https://github.com/rothgar/awesome-tuis) - List of projects that provide terminal user interfaces
- [charminULTRA/Klipper-Input-Shaping-MK3S-Upgrade](https://github.com/charminULTRA/Klipper-Input-Shaping-MK3S-Upgrade) - Easy-to-follow instructions for adding Input Shaping to your Prusa MK3S/+ using Kipper
...
- [joylarkin/AI-Coding-Landscape](https://github.com/joylarkin/AI-Coding-Landscape) - AI coding models, agents, CLIs, IDEs, AI app builders, open source tooling, benchmarks
...
- [ContainerCraft/100DaysOfHomelab](https://github.com/ContainerCraft/100DaysOfHomelab) - ~~ Begins Summer 2024 ~~
...
- [boehs/awesome-cloud-storage-abuse](https://github.com/boehs/awesome-cloud-storage-abuse) - 💸 i can haz free?
...
- [mbianchiutils/financial-cool](https://github.com/mbianchiutils/financial-cool) - A list of financial cool resources, projects and products
...
- [iakat/stars](https://github.com/iakat/stars) - iakat/stars - An awesome list of my starred repositories
...
- [tsdko/long-live-pomf](https://github.com/tsdko/long-live-pomf) - Pomf.se alternatives
...
- [jprochazka/adsb-receiver](https://github.com/jprochazka/adsb-receiver) - Create your own ADS-B receiver.
...
- [stasikos/sdiag](https://github.com/stasikos/sdiag) - Implementation of PieSpy alghoritms in perl for offline log parsing
...
- [Nwokike/DDGS](https://github.com/Nwokike/DDGS) - Metasearch across 14 engines (DuckDuckGo, Google, Brave, Bing, Yahoo, Yandex, Startpage, Wikipedia, and more) with full privacy. Built with Flet for Android.
- [linuxgemini/le-mitel-fw-tools](https://github.com/linuxgemini/le-mitel-fw-tools) - Firmware Tools for Mitel/Aastra DECT Handsets
- [LinuxlasGNUleaf/hexidian](https://github.com/LinuxlasGNUleaf/hexidian) - An event broker between GURU3 (frontend self-registration software for consumers), Asterisk (PBX software) and the Mitel Open Mobility Manager (DECT antenna and handset manager), which is accessed via
- [emfcamp/SoftRFP-Python](https://github.com/emfcamp/SoftRFP-Python) - Virtual DECT RFP for Mitel OMM
...
- [rusty3699/termradar](https://github.com/rusty3699/termradar) - Live aircraft radar in your terminal. See nearby flights, distance, direction, altitude, speed, airline, and route information.
- [AmiiboDB/Amiibo](https://github.com/AmiiboDB/Amiibo) - Amiibo .bin and .nfc database
- [nicolas-fricke/ha-component-comelit-intercom](https://github.com/nicolas-fricke/ha-component-comelit-intercom) - Custom Add-Ons for Home Assistant
- [kc1awv/rrcd](https://github.com/kc1awv/rrcd) - rrcd - Reticulum Relay Chat (RRC) implementation reference with extensions
- [mgwein/cardputer](https://github.com/mgwein/cardputer) - 
...
- [androidtrackers/android-enterprise-devices](https://github.com/androidtrackers/android-enterprise-devices) - Tracking Google Enterprise Android Devices
- [darksidelemm/spyserver_wspr_skimmer](https://github.com/darksidelemm/spyserver_wspr_skimmer) - Work-in-progress WSPR skimmer using a SpyServer
- [RFnexus/modem73interface](https://github.com/RFnexus/modem73interface) - A RNS Custom Interface for working with modem73
- [Appz4Fun/nzbdavkodi](https://github.com/Appz4Fun/nzbdavkodi) - Kodi 21 addon — stream Usenet via NZBHydra2 + nzbdav WebDAV. TMDBHelper player integration, PTT filtering, auto-updates via Kodi repository.
- [mcpcap/mcpcap](https://github.com/mcpcap/mcpcap) - Network analysis for the AI age
- [kubevoip/kubevoip](https://github.com/kubevoip/kubevoip) - KubeVoIP is a Kubernetes-native SIP and VoIP platform.
...
- [Quad4-Software/MeshChatX](https://github.com/Quad4-Software/MeshChatX) - All-in-one Reticulum client
...
- [youcefl/ecmx](https://github.com/youcefl/ecmx) - A Python wrapper over GMP-ECM
- [dddabtc/winremote-mcp](https://github.com/dddabtc/winremote-mcp) - Windows Remote MCP Server — 40+ tools for desktop automation, process management, file operations via FastMCP
- [leewhitfield/perceptor](https://github.com/leewhitfield/perceptor) - 
- [open-jarvis/OpenJarvis](https://github.com/open-jarvis/OpenJarvis) - Personal AI, On Personal Devices
- [worldwidelaw/legal-sources](https://github.com/worldwidelaw/legal-sources) - Open-source collection scripts for open legal data from 110+ countries maintained by the Legal Data Hunter agent. Request your government's data source or contribute a script.
- [mitmproxy/mitmproxy](https://github.com/mitmproxy/mitmproxy) - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
- [cryptnox/cryptnox-fido2-bridge](https://github.com/cryptnox/cryptnox-fido2-bridge) - Linux HID to PC/SC bridge for FIDO2 smart cards.
- [StarGate01/CTAP-bridge](https://github.com/StarGate01/CTAP-bridge) - FIDO2 PC/SC CTAPHID Bridge
- [BryanJacobs/fido2-hid-bridge](https://github.com/BryanJacobs/fido2-hid-bridge) - HID -&gt; PC/SC Bridge for FIDO2 Device Use
...
- [adamczykpiotr/adsb-poland-history](https://github.com/adamczykpiotr/adsb-poland-history) - Traces of all flights happening over Polish territory
...
- [gretel/chirpmunk-gr4](https://github.com/gretel/chirpmunk-gr4) - C++23 LoRa PHY transceiver and wideband scanner built on MIT Radio 4, paired with a Python toolchain for monitoring, decoding, and telemetry
...
- [mc343/FrenchRentalScanner](https://github.com/mc343/FrenchRentalScanner) - 🏠 Automatically scan French rental websites (SeLoger, LeBonCoin) for listings. Filter by price, area, location. Track favorites with live dashboard.
- [WizzardDr/TetraEar-BladeRF](https://github.com/WizzardDr/TetraEar-BladeRF) - TETRA decoder for BladeRF & RTL-SDR with voice decoding, encryption support, and real-time spectrum analyzer
- [syrex1013/TetraEar](https://github.com/syrex1013/TetraEar) - TETRA decoder for RTL-SDR with voice decoding, encryption support, and real-time spectrum analyzer
- [aklofas/kicad-happy](https://github.com/aklofas/kicad-happy) - AI coding agent skills for KiCad electronics design. Works with Claude Code and OpenAI Codex. Analyze schematics, review PCB layouts, EMC pre-compliance, SPICE simulation, download datasheets, source 
- [Burla-Cloud/burla](https://github.com/Burla-Cloud/burla) - The simplest way to scale Python.
...
- [kc1awv/rrc-web](https://github.com/kc1awv/rrc-web) - RRC Web - RRC client compatible with rrcd v0.1+ and a web based frontend
...
- [guyroyse/rserver](https://github.com/guyroyse/rserver) - A very basic HTTP server designed to work over the Reticulum Network
- [WizTheAgent/IronMesh](https://github.com/WizTheAgent/IronMesh) - Local-first, end-to-end encrypted agent-to-agent mesh protocol. Zero-config LAN + LoRa. Runs offline. No cloud. info@ironmesh.org
- [denya/sonos-lastfm](https://github.com/denya/sonos-lastfm) - Scrobble music playing on your Sonos speakers to Last.fm. Helps me with Spotify playing on Sonos!
- [kc1awv/rrc-gui](https://github.com/kc1awv/rrc-gui) - A wxWidgets GUI client implementation for rrcd
- [kc1awv/rrc-tui](https://github.com/kc1awv/rrc-tui) - A Text User Interface (TUI) client for RRC (Reticulum Relay Chat)
- [cyberjunky/addon-p2000_rtlsdr](https://github.com/cyberjunky/addon-p2000_rtlsdr) - Receive P2000 events using Home Assistant and your RTL-SDR dongle
...
- [offworldlabs/retina-node](https://github.com/offworldlabs/retina-node) - Orchestrator repository for Retina passive radar nodes
...
- [Libera-Chat/pyrite](https://github.com/Libera-Chat/pyrite) - IRCv3 downgrade bot
...
- [Udo/opnsense-openwrt-admin](https://github.com/Udo/opnsense-openwrt-admin) - Admin a fleet of OpenWrt routers
...
- [abhishukla0204/Quantalytics-26](https://github.com/abhishukla0204/Quantalytics-26) - An end-to-end quantitative research project designed to identify and exploit trading signals in Gold and Silver markets. This implementation features dynamic position sizing, rigorous transaction cost
...
- [PaulBone/gfthings](https://github.com/PaulBone/gfthings) - Paul's Gridfinity Things
- [michaelgale/cq-gridfinity](https://github.com/michaelgale/cq-gridfinity) - A python library to build parameterized gridfinity compatible objects such a baseplates and boxes.
- [LLMSecurity/MasterKey](https://github.com/LLMSecurity/MasterKey) - MASTERKEY is a framework designed to explore and exploit vulnerabilities in large language model chatbots by automating jailbreak attacks and evaluating their defenses.
- [patrickrchao/JailbreakingLLMs](https://github.com/patrickrchao/JailbreakingLLMs) - 
- [RICommunity/TAP](https://github.com/RICommunity/TAP) - TAP: An automated jailbreaking method for black-box LLMs
- [AIM-Intelligence/Automated-Multi-Turn-Jailbreaks](https://github.com/AIM-Intelligence/Automated-Multi-Turn-Jailbreaks) - 
- [istupakov/onnx-asr](https://github.com/istupakov/onnx-asr) - A lightweight Python package for Automatic Speech Recognition using ONNX models
- [loudpage/parakeet-v3-diarized](https://github.com/loudpage/parakeet-v3-diarized) - Parakeet 0.6b V3 + Pyannote diarization behind a Whisper API
- [matvik22000/rns-over-icmp](https://github.com/matvik22000/rns-over-icmp) - 
- [kc1awv/lxst_phone](https://github.com/kc1awv/lxst_phone) - Voice over Reticulum (VoR) Prototype
...
- [OpenHands/OpenHands-Cloud](https://github.com/OpenHands/OpenHands-Cloud) - All Hands AI OpenHands Self-hosted Cloud
- [Bclound/searCrawl](https://github.com/Bclound/searCrawl) - Sear-Crawl4AI is an open-source search and crawling tool based on SearXNG and Crawl4AI, serving as an open-source alternative to Tavily. It provides similar search and web content extraction capabilit
...
- [python-metar/python-metar](https://github.com/python-metar/python-metar) - a python package that parses coded METAR weather reports.
...
- [trixmoe/tls-expiry-tracker](https://github.com/trixmoe/tls-expiry-tracker) - Track outages caused by TLS errors (incl. expiry)
- [webrecorder/har2warc](https://github.com/webrecorder/har2warc) - Convert HTTP Archive (HAR) -&gt; Web Archive (WARC) format
- [cabernetwork/cabernet](https://github.com/cabernetwork/cabernet) - Cabernet allows control of IPTV streams. Plugins supports Pluto TV, XUMO, M3U/XMLTV.XML files
- [2292402583/PCILeech_MASK_Writemask_Automation_Tool](https://github.com/2292402583/PCILeech_MASK_Writemask_Automation_Tool) - By leveraging this tool, users can automate the otherwise tedious process of testing and validating PCIe device configuration spaces, significantly improving efficiency and accuracy.利用arbor Python功能读写
- [sinwindie/OSINT](https://github.com/sinwindie/OSINT) - Collections of tools and methods created to aid in OSINT collection
- [DavidBerdik/blobmoji2](https://github.com/DavidBerdik/blobmoji2) - A fork of googlefonts/noto-emoji updated to use C1710/blobmoji.
...
- [jerpint/context-llemur](https://github.com/jerpint/context-llemur) - Context management tool for LLM collaboration
...
- [javirs200/myADS-B_ESP32_client](https://github.com/javirs200/myADS-B_ESP32_client) - ESP32 client for ADS-B api https://api.adsb.lol
- [x86ed/adsb.lol-mcp](https://github.com/x86ed/adsb.lol-mcp) - A Model Context Protocol interface to the adsb.lol api
- [marklit/adsb_json](https://github.com/marklit/adsb_json) - Enrich adsb.lol's feeds and partition them into 1M-line, GZIP-compressed JSONL files
...
- [pytest-dev/nose2pytest](https://github.com/pytest-dev/nose2pytest) - Scripts to convert Python Nose tests to PyTest
- [WPTK/ADSB-TUI](https://github.com/WPTK/ADSB-TUI) - ADS-B Tracker TUI is a Python-based terminal interface for tracking aircraft data using dump1090 or compatible ADS-B receivers. It displays real-time aircraft information in a retro-style interface, a
- [p85/cliradar](https://github.com/p85/cliradar) - Plots ADS-B Data from Dump1090 in your Terminal
...
- [NatLabRockies/mappymatch](https://github.com/NatLabRockies/mappymatch) - Pure-python package for map matching
- [DirkReiners/LEDBadgeProgrammer](https://github.com/DirkReiners/LEDBadgeProgrammer) - Little tool to program LED name badges
...
- [Vgr255/pyPod7](https://github.com/Vgr255/pyPod7) - A Python script for syncing 7th gen iPod nano music files without iTunes
...
- [Jekso/AndroidTV-Remote-Controller](https://github.com/Jekso/AndroidTV-Remote-Controller) - Effortlessly control your Android TV using Python and ADB
...
- [ArchiveTeam/urls-sources](https://github.com/ArchiveTeam/urls-sources) - Sources for urls-grab.
...
- [danielfullmer/nzbfs](https://github.com/danielfullmer/nzbfs) - NZB Filesystem using FUSE/Python
...
- [maputnik/osm-liberty](https://github.com/maputnik/osm-liberty) - A free Mapbox GL basemap style for everyone
- [ifd3f/CatGPT](https://github.com/ifd3f/CatGPT) - A Superintelligent AI capable of holding a conversation with a cat
...
- [martin-kokos/kiwi-berry](https://github.com/martin-kokos/kiwi-berry) - A kiwi.cum API client
...
- [wenleix/hypercorn_ws](https://github.com/wenleix/hypercorn_ws) - Demonstrate hypercorn websocket connection close code upon uncaught exception in application
...
- [acehoss/rnsh](https://github.com/acehoss/rnsh) - rnsh is a command-line utility written in Python that facilitates shell sessions over Reticulum networks and aims to provide a similar experience to SSH.
...
- [markqvist/RNode_Firmware](https://github.com/markqvist/RNode_Firmware) - RNode is an open, free and flexible digital radio interface with many uses
...
- [hlohaus/gpt4free](https://github.com/hlohaus/gpt4free) - The official gpt4free repository | various collection of powerful language models
...
- [edera-dev/linux-kernel-oci](https://github.com/edera-dev/linux-kernel-oci) - Build the Linux kernel into OCI images, suitable for Edera products.
- [stanford-oval/storm](https://github.com/stanford-oval/storm) - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
- [mrihtar/SRTM1-Global](https://github.com/mrihtar/SRTM1-Global) - Tools for parsing and using USGS SRTM 1 Arc-Second Global (30m) and ALOS World 3D-30m (AW3D30) elevation data
...
- [wiedehopf/adsb-feeder-image](https://github.com/wiedehopf/adsb-feeder-image) - Easy to use turn-key SD card image for a number of popular single board computers to run a complete ADS-B feeder
...
- [ncoevoet/ChanTracker](https://github.com/ncoevoet/ChanTracker) - supybot ban management and channel flood/spam/repeat protections plugin
...
- [pr3d4t0r/sopel_ai](https://github.com/pr3d4t0r/sopel_ai) - PerplexiPy / Perplexity AI / Ollama/llama.cpp plug-in for the Sopel bot
- [Amsterdam-bene/blablabla](https://github.com/Amsterdam-bene/blablabla) - A chatbot service bene.
- [dillonwilliams/signal-chatgpt](https://github.com/dillonwilliams/signal-chatgpt) - Signal-ChatGPT relay via OpenAI API
...
- [mattsta/redisfuse](https://github.com/mattsta/redisfuse) - FUSE File System for Redis specializing in CRUDing strings and hashes (and R of everything else) (Note: this is obviously ancient and is only a historical artifact now; not really a good example of co
...
- [ARPSyndicate/puncia](https://github.com/ARPSyndicate/puncia) - Panthera(P.)uncia - Official CLI utility for Subdomain Center & Exploit Observer.
...
- [snstac/adsbcot](https://github.com/snstac/adsbcot) - Display Aircraft in TAK - ADS-B to TAK Gateway
...
- [wiedehopf/mlat-server](https://github.com/wiedehopf/mlat-server) - fork of https://github.com/mutability/mlat-server
...
- [KnugiHK/WhatsApp-Chat-Exporter](https://github.com/KnugiHK/WhatsApp-Chat-Exporter) - A customizable, cross-platform tool for parsing WhatsApp chat databases from Android and iOS/iPadOS backups. Supports Android .crypt12, .crypt14, .crypt15, and the latest database formats. Outputs cha
...
- [Teekeks/pyTwitchAPI](https://github.com/Teekeks/pyTwitchAPI) - A Python 3.7 compatible implementation of the Twitch API, EventSub and Chat
...
- [alexandriax/cuteuid](https://github.com/alexandriax/cuteuid) - 😊 Generate cute UIDs
...
- [marko0905/websearch-rs](https://github.com/marko0905/websearch-rs) - Keyless multi-engine web search for Rust — a pure-Rust port of Python's ddgs. Aggregates DuckDuckGo, Bing, Brave, Mojeek, Yandex, Startpage & more via browser TLS (JA3/JA4)   ▎ impersonation. No API k
...
- [impiaaa/ios-notif-forward](https://github.com/impiaaa/ios-notif-forward) - Forward notifications from Apple devices to your desktop
- [tnAnGel/Aegis](https://github.com/tnAnGel/Aegis) - Self-hosted anti-DDoS reverse proxy and WAF in Rust — WAF, JA3/JA4 fingerprinting, eBPF/XDP, challenge ladder, HTTP/3
...
- [biandratti/huginn-proxy](https://github.com/biandratti/huginn-proxy) - High-performance reverse proxy forwarding TLS (JA4), HTTP/2 (Akamai), and TCP-SYN (eBPF-powered) fingerprints as HTTP headers
- [dimforge/vortx](https://github.com/dimforge/vortx) - Cross-platform GPU tensor library in Rust
...
- [grdw/viper-client](https://github.com/grdw/viper-client) - This code features a viper-client, which can connect to a viper-server, a custom interface made for Comelit devices.
...
- [iandees/osm-gpui](https://github.com/iandees/osm-gpui) - An OSM editor using the Rust-based GUI framework gpui.
- [razvanzeces/flowstation](https://github.com/razvanzeces/flowstation) - TETRA base station in software — runs on Raspberry Pi, works with real TETRA radios. Built in Rust.
- [qewer33/sdrrat](https://github.com/qewer33/sdrrat) - discover the RF spectrum from your terminal
- [izzyabelle/passcli](https://github.com/izzyabelle/passcli) - 
...
- [AusAgentSmith-org/nzbdav-rs](https://github.com/AusAgentSmith-org/nzbdav-rs) - Usenet virtual filesystem with WebDAV serving — stream files directly from Usenet without downloading
...
- [mustang6139/sdrtop](https://github.com/mustang6139/sdrtop) - Terminal monitor for SDR hardware - written in Rust. Early development.
- [quickwit-oss/tantivy](https://github.com/quickwit-oss/tantivy) - Tantivy is a full-text search engine library inspired by Apache Lucene and written in Rust
- [gretel/chirpmunk-rs](https://github.com/gretel/chirpmunk-rs) - Rust LoRa PHY transceiver and wideband scanner built on Future SDR
- [dfrg/zeno](https://github.com/dfrg/zeno) - High performance, low level 2D path rasterization library in pure Rust.
- [Mic92/zfs-dedup](https://github.com/Mic92/zfs-dedup) - offline deduplication for zfs
...
- [lora-rs/lora-rs](https://github.com/lora-rs/lora-rs) - LoRa and LoRaWAN crates for End Devices
...
- [nambok/mentedb](https://github.com/nambok/mentedb) - A cognition aware database engine for AI agent memory. Purpose built in Rust with WAL, HNSW, knowledge graphs, and speculative context pre assembly. Not a wrapper, a ground up storage engine that thin
- [fathyb/carbonyl](https://github.com/fathyb/carbonyl) - Chromium running inside your terminal
- [johnsideserf/siggy](https://github.com/johnsideserf/siggy) - Terminal-based Signal messenger client with vim keybindings
...
- [nasty-project/nasty](https://github.com/nasty-project/nasty) - bcachefs based NAS solution
...
- [ananthb/starla](https://github.com/ananthb/starla) - Unofficial RIPE Atlas Software Probe in Rust
...
- [The-Swarm-Corporation/swarms-rs](https://github.com/The-Swarm-Corporation/swarms-rs) - The Enterprise-Grade Production-Ready Multi-Agent Orchestration Framework in Rust
...
- [lessneek/mullvadwaita](https://github.com/lessneek/mullvadwaita) - Mullvad VPN service controller app implemented with libadwaita.
- [jamesmcm/vopono](https://github.com/jamesmcm/vopono) - Run applications through VPN tunnels with temporary network namespaces
- [DPRK-KCC/mullvad-socks](https://github.com/DPRK-KCC/mullvad-socks) - Filter Mullvad's SOCKS5 proxies by country, city, weight and online status.
- [azenla/tinyvm](https://github.com/azenla/tinyvm) - Tiny Bytecode VM
...
- [pando85/passless](https://github.com/pando85/passless) - Virtual FIDO2 device and client FIDO 2 utility
...
- [MidnightBlueLabs/tetra-bluestation](https://github.com/MidnightBlueLabs/tetra-bluestation) - An implementation of (large parts of) the TETRA stack, usable for primitive base station functionality
- [jgraef/pbr-presets](https://github.com/jgraef/pbr-presets) - Rust constants for a selection of PBR materials
...
- [8b-is/smart-tree](https://github.com/8b-is/smart-tree) - Smart Tree: not just a tree, a philosophy. A context-aware, AI-crafted replacement for 20+ tools with MEM8 quantum compression, semantic search, AST-smart editing, and partnership memory. Crafted with
...
- [jcbsnclr/ksync](https://github.com/jcbsnclr/ksync) - an okay file synchronisation solution, written in Rust
...
- [jake-low/barchart](https://github.com/jake-low/barchart) - Command line tool to print simple bar charts
- [wiedehopf/acars-bridge](https://github.com/wiedehopf/acars-bridge) - 
...
- [joelparkerhenderson/sha256-sentence](https://github.com/joelparkerhenderson/sha256-sentence) - SHA256 sentence: discover a SHA256 checksum that matches a sentence's description of hex digit words.
- [FyraLabs/chisel-operator](https://github.com/FyraLabs/chisel-operator) - Kubernetes Operator for Chisel
...
- [Gelbpunkt/zangy](https://github.com/Gelbpunkt/zangy) - A fast redis library for python and asyncio written in Rust
...
- [SoftbearStudios/mk48](https://github.com/SoftbearStudios/mk48) - Mk48.io ship combat game (repository commits may lag behind game updates)
...
- [dect-e/howto-dect](https://github.com/dect-e/howto-dect) - Setting up a Mitel SIP-DECT RFP for home/enthusiast use
- [dsieradzki/makoon](https://github.com/dsieradzki/makoon) - A Web Application for easy Kubernetes Cluster Management for Proxmox VE
...
- [trixmoe/TrixPhone](https://github.com/trixmoe/TrixPhone) - My SIP server (for me and friends and co.)
- [jim-collier/x9dedupe](https://github.com/jim-collier/x9dedupe) - The first ZFS offline deduplication tool. Also deduplicates Btrfs and XFS.
- [osx-tools/asahi-encrypt](https://github.com/osx-tools/asahi-encrypt) - The script that encrypts `Fedora Asahi Remix` linux installation
- [JLSchuler99/photonicat2-openwrt](https://github.com/JLSchuler99/photonicat2-openwrt) - 
...
- [EkinStrop/openwrt-bpi-r4-wifi7-builder](https://github.com/EkinStrop/openwrt-bpi-r4-wifi7-builder) - OpenWrt 25.12 build system for Banana Pi BPI-R4 with WiFi 7 (802.11be) and unrestricted wireless regulatory database
- [dockur/macos](https://github.com/dockur/macos) - MacOS inside a Docker container.
- [dockur/windows](https://github.com/dockur/windows) - Windows inside a Docker container.
- [nyxxxie/de-LUKS](https://github.com/nyxxxie/de-LUKS) - Implementation of an evil maid attack against Linux's most popular full-disk encryption tool
- [avibrazil/iLinuxNetworkBackup](https://github.com/avibrazil/iLinuxNetworkBackup) - Prepare Linux as an iOS backup server, with network backups capabilities
- [anatol/clevis-extra-pins](https://github.com/anatol/clevis-extra-pins) - Additional clevis pins
...
- [wiedehopf/tar1090-aux](https://github.com/wiedehopf/tar1090-aux) - auxiliary data for tar1090
...
- [alphapapa/restic-runner](https://github.com/alphapapa/restic-runner) - Configure and run Restic more easily
- [biappi/anyka-fw](https://github.com/biappi/anyka-fw) - 
...
- [sdr-enthusiasts/docker-shipfeeder](https://github.com/sdr-enthusiasts/docker-shipfeeder) - AIS feeder for ShipXplorer, VesselFinder, MarineTraffic, etc. based on AIS-Catcher. Multi-architecture (amd64, armhf, arm64)
...
- [ketilmo/balena-ads-b](https://github.com/ketilmo/balena-ads-b) - ADS-B Flight Tracker running on balena with support for FlightAware, Flightradar24, Plane Finder, OpenSky Network, AirNav Radar, ADSB Exchange, Wingbits, adsb.fi, ADSB.lol, ADS-B One, airplanes.live, 
...
- [psharma04/inertia](https://github.com/psharma04/inertia) - Reticulum/LXMF client for iOS
- [pablots25/ft_ham](https://github.com/pablots25/ft_ham) - An iOS application for FT8/FT4 digital amateur radio communication. FT Ham enables amateur radio operators to encode, transmit, receive, and decode FT8/FT4 signals with support for logbook management 
- [traccar/apple-find-my-sync](https://github.com/traccar/apple-find-my-sync) - Synchronize Apple AirTag locations with Traccar
...
- [kilmu1337/VGK-DMA-BYPASS](https://github.com/kilmu1337/VGK-DMA-BYPASS) - 
- [Simonrak/rtl8852ae-bar-controller-pcileech](https://github.com/Simonrak/rtl8852ae-bar-controller-pcileech) - rtl8852ae bar controller pcileech
...
- [0x20/hackerspace-blueprint](https://github.com/0x20/hackerspace-blueprint) - The Hackerspace Blueprint
...
- [Manaf941/opencode-goal-plugin](https://github.com/Manaf941/opencode-goal-plugin) - OpenCode goal plugin for Codex-style goal mode, /goal slash commands, persistent objectives, and AI coding agent focus.
- [LinkPhoenix/stalwart-webui-fork](https://github.com/LinkPhoenix/stalwart-webui-fork) - Stalwart WebUI
...
- [portapack-mayhem/MayhemHub](https://github.com/portapack-mayhem/MayhemHub) - Web interface for everything HackRF/Portapack
- [angristan/pastekey](https://github.com/angristan/pastekey) - Passkey-only, end-to-end encrypted text and file sharing, running on Cloudflare Workers.
...
- [Constella-OS/constella-desktop](https://github.com/Constella-OS/constella-desktop) - Index all your local files + cloud apps privately, on-device with VectorDB & KnowledgeGraph in one
- [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) - #1 Persistent memory for AI coding agents based on real-world benchmarks
- [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything) - Graphs that teach &gt; graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex, Cursor, Copilot, Gemini C
- [jhbruhn/respira](https://github.com/jhbruhn/respira) - Controller Software for the Brother PP-1 SKiTCH embroidery machine.
...
- [falcononrails/jinka-mcp](https://github.com/falcononrails/jinka-mcp) - Private MCP server for Jinka real-estate alerts
...
- [coder/blink](https://github.com/coder/blink) - Blink is a self-hosted platform for building and running custom, in-house AI agents.
...
- [sidereal-io/sidereal](https://github.com/sidereal-io/sidereal) - Sync astrophotography images from Immich, plate solve them with Astrometry.net, and enrich with searchable celestial metadata.
...
- [yorch/ovh-availability-checker](https://github.com/yorch/ovh-availability-checker) - Check if an OVH / Kimsufi / SoYouStart server is on stock or not
...
- [lichess-org/zulip-remind](https://github.com/lichess-org/zulip-remind) - Zulip bot that posts messages in a stream at a fixed date.
...
- [ret2c/pcileech-cfw](https://github.com/ret2c/pcileech-cfw) - CFW for DMA research
...
- [yxlnqs/Diviner-full-emu-](https://github.com/yxlnqs/Diviner-full-emu-) - DMA Firmware
- [ekknod/pcileech-wifi](https://github.com/ekknod/pcileech-wifi) - pcileech-fpga with wireless card emulation
...
- [open-aviation/tangram](https://github.com/open-aviation/tangram) - An open platform for modular, real-time aviation research
- [bellingcat/adsb-history](https://github.com/bellingcat/adsb-history) - Collect and query ADS-B data to find aircraft and trends based on geographic region(s), altitude, bearing, aircraft type and more.
...
- [aabounegm/immich-location-history-reconciler](https://github.com/aabounegm/immich-location-history-reconciler) - A webapp for adding location information to Immich assets using Google Maps timeline export
...
- [uamphome/micro_matter_button](https://github.com/uamphome/micro_matter_button) - Matter Button Built on Holyiot 25008 and 25015 with the nrf54l15
...
To the extent possible under law, [iakat](https://github.com/iakat) has waived all copyright and related or neighboring rights to this work.
